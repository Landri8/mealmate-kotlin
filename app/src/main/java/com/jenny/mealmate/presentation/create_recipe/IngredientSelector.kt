// app/src/main/java/com/jenny/mealmate/presentation/create_recipe/IngredientSelector.kt
...
fun IngredientSelector(
    ...
    val displayText = ingredients.firstOrNull { it.id == selectedIngredientId }?.name
        ?: "Select ingredient"
    ...
    ExposedDropdownMenuBox(
        ...
        TextField(
            ...
            textStyle = androidx.compose.ui.text.TextStyle(
                fontFamily = poppinsFamily,
                fontSize = 16.sp,
                color = if (displayText == "Select ingredient")
        ...
        ExposedDropdownMenu(
            ...
            ingredients.forEach { ing ->
                DropdownMenuItem(
                    text = { Text(ing.name, fontFamily = poppinsFamily) },
                    onClick = {
                        onIngredientSelected(ing.id)
                        expanded = false
                    },
                    enabled = enabled
                )
